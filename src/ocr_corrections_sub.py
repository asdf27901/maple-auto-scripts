...
_RAW_ERRORS = [
    ...
    # 终伤
    "最终傷害：+25%", "最终傷害: +25%", "最终傷害： +25%", "最终傷害:+25%",
    "最終傷害：+25%", "最終傷害: +25%", "最終傷害： +25%", "最終傷害:+25%",
    "最终害：+25%", "最终害: +25%", "最终害： +25%", "最终害:+25%",
    "最終害：+25%", "最終害: +25%", "最終害： +25%", "最終害:+25%",
    "最害：+25%", "最害: +25%", "最害： +25%", "最害:+25%",
...
def _generate_fix_map():
    ...
    for err_str in candidates:
        ...
        if '最终伤害' in matched_target:
            fix_map[err_str] = matched_target
            continue
